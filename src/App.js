...
function App() {
        ...
        >
          <View style={styles.rotateView}>
            ...
            <tspan> (3/6)</tspan> */}
              ...
              <G className="court" transform="translate(20, 50)">
                <Rect
                  fill={playerId ? theme.colors.lightCard : theme.colors.card}
                  x="-20"
                  y="-20"
                  width="560"
                  height="510"
                ...
                <G className="markings">
                  <Image
                    ...
                    opacity="1"
                    href={returnTeamPhotoSource(hTeamId)}
                  ></Image>
                  <Path
                    className="mark"
                    fill="none"
              ...
              <G className="watermark" transform="translate(520, 520)"></G>
            </Svg>
          </View>
          ...
          >
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              <Entypo name="circle" size={14} color="green" />
            ...
            >
              <FontAwesome name="close" size={14} color="red" />
              <Text style={{ color: theme.colors.text, marginLeft: 5 }}>
                Missed
              </Text>
            </View>
  ...
  const MarkTheShot = ({ index, play }) => {
    return (
      <G key={index} className="shot">
        <Path
          transform={`translate(${250 + play.xLegacy}, ${play.yLegacy + 50})`}
          d={
            play.shotResult === "Made"
              ? `M -5, 0 a 5,5 0 1,0 10,0 a 5,5 0 1,0 -10,0`
              : `M -5,-5 L 5,5 M 5,-5 L -5,5`
          }
          fill="rgba(255,255,255, 0.1)"
          stroke={
            play.shotResult === "Made" ? "#2e8540" : `rgba(163, 0, 0, 0.8)`
          }
          strokeWidth="3"
        ></Path>
      </G>
